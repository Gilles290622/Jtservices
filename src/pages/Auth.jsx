...
const AuthPage = () => {
  ...
  const handleSignup = async (e) => {
    ...
    let projectTypeForSignup = 'lafoi'; // Default
    if (from.startsWith('/caisse')) {
        projectTypeForSignup = 'caisse';
    } else if (from.startsWith('/fichiers')) {
        projectTypeForSignup = 'fichiers';
    }
    ...
    const { error } = await supabase.auth.signUp({
      ...
      options: {
        data: {
          full_name: fullName,
          username: username,
          project_type: projectTypeForSignup
        },
      },
    });
    setLoading(false);
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Connectez-vous ou inscrivez-vous pour accéder aux services JTS." />
      </Helmet>
